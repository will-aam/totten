// app/admin/anamnesis/new/page.tsx
"use client";
...
export default function NewAnamnesisTemplatePage() {
  ...
  const [fields, setFields] = useState<FormField[]>([
    ...
    },
    {
      ...
      label: "Tipo de Pele",
      type: "single_choice",
      options: ["Normal", "Seca", "Oleosa", "Mista"],
    },
  ]);
  ...
  const handleSave = async () => {
    ...
    if (result.success) {
      toast({ title: "Sucesso!", description: "Modelo de ficha salvo." });
      window.location.href = "/admin/anamnesis";
    } else {
      toast({
        title: "Erro",
