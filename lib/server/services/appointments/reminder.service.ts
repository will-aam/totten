// lib/server/services/appointments/reminder.service.ts
import { getTenantPrisma } from "@/lib/prisma";

export class ReminderService {
  /**
   * Busca os lembretes de agendamentos com base na data fornecida ou para o dia seguinte (padrão).
   * Aplica a correção de fuso horário para UTC-3 (Brasília).
   */
  static async getReminders(organizationId: string, dateParam: string | null) {
