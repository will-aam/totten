        ...
        >
          ...
          <div className={cn(
            ...
            <p
              ...
              style={{ color: theme.textColor }}
            >
              {profile.bio || "Sua biografia aparecer├í aqui..."}
            </p>

            {/* Renderiza as redes sociais no Topo (acima dos bot├Áes) */}
            ...
            <div className="w-full mt-6 flex flex-col gap-3">
              {links.map((link: any) => (
                ...
                >
                  {link.title || "Novo Bot├úo"}
                </div>
              ))}
            </div>

            <div className="mt-auto w-full pt-8 flex flex-col items-center">
              {/* Renderiza as redes sociais no Rodap├® (abaixo dos bot├Áes) */}
